...
def transform_forecast_wind_and_coastal_water_conditions(
    ...
    """
    Transform the forecast wind and coastal water conditions DataFrame objet
    ...
    :param forecast_wind_and_coastal_water_conditions_dataframe: DataFrame
        containing the forecast wind and coastal water of the daily weather
        forecast
    :type forecast_wind_and_coastal_water_conditions_dataframe: pd.DataFrame

    :return: Transformed DataFrame containing the cleaned, normalized, and
        standardized forecast wind and coastal water conditions of the daily
        weather forecast
    :rtype: DataFrame
    """
    # Initialized DataFrame to store cleaned, normalized, and standardized data
