...
def extract_2025_tc_associated_rainfall_tags(
    ...
    tc_associated_rainfall_tags = select_tag_with_form_control_classs.find_all(
        'option'
    )[1:]

    return tc_associated_rainfall_tags
