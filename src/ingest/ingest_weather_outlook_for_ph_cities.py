"""
Ingest weather outlook for selected Philippine cities data from the PAGASA-DOST website.
...
- Weather outlook for Philippine cities
"""
import os
import requests
import json
...
def ingest_issued_datetime(
    ...
    :return: Issued datetime from the weather outlook for
        selected Philippine cities page of the PAGASA-DOST
        website
    :rtype: str
    """
    issued_datetime = ''
...
def save_ingested_issued_datetime(
    ...
    :param issued_datetime: Issued datetime from the
        weather outlook for selected Philippine cities
        page of the PAGASA-DOST website
    ...
    ingested_data = [
        {
            "isssued_datetime": issued_datetime
        }
    ]
...
def ingest_time_validity(
    ...
    """
    Ingest the time validity from the
    weather outlook for selected Philippine
    cities page of the PAGASA-DOST website.
    ...
    :return: Time validity from the weather outlook for
        selected Philippine cities page of the PAGASA-
        DOST website
    :rtype: str
    """
    time_validity = ''
...
def save_ingested_time_validity(
    ...
    """
    Save the ingested time validity from the weather
    outlook for selected Philippine cities page of the
    PAGASA-DOST website.

    :param time_validity: Time validity from the weather
...
def map_ph_city_names_to_weather_dates(
    ...
    :param list_of_all_weather_dates: List of all weather
        dates for selected Philippine cities
...
def ingest_chance_of_rain_percentages(
    ...
    :return: List of all chance of rain percentages for
...
def map_ph_city_names_to_chance_of_rain_percentages(
    ...
    :param list_of_all_chance_of_rain_percentages: List of all
        chance of rain percentages for selected Philippine cities
    :type list_of_all_chance_of_rain_percentages: list[list]

    :return: Weather outlook for selected Philippine cities
    :rtype: dict[str, dict]
    """
...
def save_ingested_weather_outlook_for_ph_cities(
        weather_outlook_for_ph_cities: dict[str, dict]
) -> None:
    """
    Save the ingested weather outlook for selected Philippine
    cities from weather outlook for selected Philippine cities
    page of the PAGASA-DOST website.

    :param weather_outlook_for_ph_cities: Weather outlook for
        selected Philippine cities
    :type weather_outlook_for_ph_cities: dict[str, dict]
    """
